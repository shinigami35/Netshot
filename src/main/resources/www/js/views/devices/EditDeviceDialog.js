...
define([
    ...
    return Dialog.extend({
        ...
        buttons: {
            "Save": function (event) {
                ...
                var device = {
                    ...
                    'emails': that.$('#devicemails').val(),
                    'onSuccess': that.$('#deviceonsuccess').is(":checked"),
                    'onError': that.$('#deviceonerror').is(":checked")
                };
        ...
        onCreate: function () {
            ...
            this.$('#deviceemails').val(this.model.get('emails'));
            this.$('#deviceonsuccess').checked = this.model.get('onSuccess');
            this.$('#deviceonerror').checked = this.model.get('onError');
        }
